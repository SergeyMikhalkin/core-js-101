...
function willYouMarryMe(isPositiveAnswer) {
  return new Promise((resolve, reject) => {
    if (isPositiveAnswer === undefined || typeof isPositiveAnswer !== 'boolean' || (Boolean(isPositiveAnswer) === false && isPositiveAnswer !== false)) reject(new Error('Wrong parameter is passed! Ask her again.'));
